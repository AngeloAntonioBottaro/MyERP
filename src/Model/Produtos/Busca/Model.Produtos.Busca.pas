...
begin
   FQueryBusca
    .Clear
    .Add('SELECT ')
    .Add('PRODUTOS.ID, PRODUTOS.NOME, PRODUTOS.CUSTO, PRODUTOS.PRECO_VENDA_VISTA, PRODUTOS.PRECO_VENDA_PRAZO, ')
    .Add('PRODUTOS.ESTOQUE, PRODUTOS.CODIGO_BARRAS, PRODUTOS.STATUS,')
    .Add('PRODUTOS_GRUPOS.NOME AS NOME_GRUPO,')
    .Add('PRODUTOS_SUBGRUPOS.NOME AS NOME_SUBGRUPO, ')
    .Add('PRODUTOS_UNIDADES.SIGLA')
    .Add('FROM PRODUTOS ')
    .Add('LEFT JOIN PRODUTOS_SUBGRUPOS ON(PRODUTOS_SUBGRUPOS.ID = PRODUTOS.ID_SUBGRUPO)')
    .Add('LEFT JOIN PRODUTOS_GRUPOS ON(PRODUTOS_GRUPOS.ID = PRODUTOS_SUBGRUPOS.ID_GRUPO)')
    .Add('LEFT JOIN PRODUTOS_UNIDADES ON(PRODUTOS_UNIDADES.ID = PRODUTOS.ID_UNIDADE)');
end;
