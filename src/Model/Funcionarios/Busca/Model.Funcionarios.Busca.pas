...
begin
   FQueryBusca
    ...
    .Add('PERMISSOES_GRUPO.ID AS ID_PERMISSAO, PERMISSOES_GRUPO.NOME AS NOME_PERMISSAO')
    .Add('FROM FUNCIONARIOS ')
    .Add('LEFT JOIN CIDADES ON(CIDADES.ID = FUNCIONARIOS.ID_CIDADE)')
    .Add('LEFT JOIN PERMISSOES_GRUPO ON(PERMISSOES_GRUPO.ID = FUNCIONARIOS.ID_PERMISSOES_GRUPO)');
end;
...
begin
   FQueryBusca
    ...
    .DisplayFormat('ID_PERMISSAO', DISPLAY_FORMAT_CODIGO);
end;
