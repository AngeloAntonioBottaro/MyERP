...
type
  ...
  public
    ...
    function Cep(AValue: Integer): TModelFornecedoresEntitie; overload;
...
function TModelFornecedoresEntitie.Cep(AValue: Integer): TModelFornecedoresEntitie;
begin
   Result := Self;
   FCep   := AValue;
end;

function TModelFornecedoresEntitie.Cep: Integer;
begin
   Result := FCep;
end;
