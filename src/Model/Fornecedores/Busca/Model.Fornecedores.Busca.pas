...
type
  ...
  public
    ...
    function IndexFieldNames(AIndex: string): TModelFornecedoresBusca;
    procedure Buscar;
  end;
...
begin
   FQueryBusca
    ...
    .Add('LEFT JOIN CIDADES ON(CIDADES.ID = FORNECEDORES.ID_CIDADE)');
end;
...
procedure TModelFornecedoresBusca.ConfFieldsMask;
begin
   FQueryBusca
...
function TModelFornecedoresBusca.IndexFieldNames(AIndex: string): TModelFornecedoresBusca;
begin
   Result := Self;
